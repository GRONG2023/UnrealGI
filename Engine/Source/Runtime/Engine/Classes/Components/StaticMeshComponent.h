...
public:
	...
	/** If true, this component will be visible in real time GI scene. */
	UPROPERTY(EditAnywhere, AdvancedDisplay, BlueprintReadOnly, Category=RealtimeGI)
	uint8 bVisibleInRealtimeGI : 1;
